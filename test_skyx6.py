...
r_r = s.get('https://jwxt.njfu.edu.cn/jsxsd/kbcx/kbxx_classroom_ifr')
soup = BeautifulSoup(r_r.text, 'html.parser')
print('selects:', [s.get('name') for s in soup.find_all('select')])
