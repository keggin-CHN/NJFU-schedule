...
r4 = s.get('https://jwxt.njfu.edu.cn/jsxsd/kbcx/kbxx_room_ifr')
soup4 = BeautifulSoup(r4.text, 'html.parser')
print('kbxx_room_ifr skyx options:', len(soup4.select('select[name=skyx] option')))
print('kbxx_room_ifr xq options:', len(soup4.select('select[name=xq] option')))
print('kbxx_room_ifr jxl options:', len(soup4.select('select[name=jxl] option')))
