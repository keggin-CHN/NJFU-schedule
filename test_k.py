...
print('kbjcmsid in page?', 'kbjcmsid' in r_home.text)
match = re.search('kbjcmsid', r_home.text)
print(r_home.text[match.start()-50:match.end()+50] if match else 'No match')
